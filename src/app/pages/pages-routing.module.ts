...
const routes: Routes = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        loadChildren: () => import('./featured-product-list/featured-product-list.module').then(m => m.FeaturedProductListModule),
        data: { preload: true, delay: false }
      },
      {
        path: 'account',
      ...
      {
        path: 'all-categories',
        loadChildren: () => import('./all-categories/all-categories.module').then(m => m.AllCategoriesModule),
        data: { preload: false, delay: true }
      },
      {
        path: 'all-feature-brands',
        loadChildren: () => import('./all-feature-brands/all-feature-brands.module').then(m => m.AllFeatureBrandsModule),
        data: { preload: false, delay: true }
      },
      {
      ...
      },
      {
        ...
        loadChildren: () => import('./upload-prescription/upload-prescription.module').then(m => m.UploadPrescriptionModule),
        canActivate: [UserAuthGuard],
        data: { preload: true, delay: false }
      },
      // Main Product Details with High Priority Router
      {
        path: ':slug',
        loadChildren: () => import('./product-details/product-details.module').then(m => m.ProductDetailsModule),
        data: { preload: true, delay: false }

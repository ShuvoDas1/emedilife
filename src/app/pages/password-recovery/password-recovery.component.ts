    ...
    this.userService.checkAndGetUserByPhone(this.phoneNo)
      .subscribe(res => {
        ...
        if (status) {
          ...
          const message = this.generatedOtpCode + ' is your OTP (One-Time Password) for password reset at E-medilife. Please enter the OTP to the verification page. Thanks.';
          // Sent Message

...
export class CategoryService {
  ...
  getAllCategoryWithCount(pagination?: Pagination, isFeatured?: boolean) {
    let params = new HttpParams();
    if (pagination) {
      params = params.append('pageSize', pagination.pageSize);
      params = params.append('page', pagination.currentPage);
    ...
    return this.httpClient.get<{ data: ProductCategory[], message?: string, count: number }>(API_CATEGORY + 'get-all-categories-with-count', { params });

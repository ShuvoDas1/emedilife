...
export class BrandService {
  ...
  getAllBrandsWithCount(pagination?: Pagination, select?: string, isFeatured?: boolean) {
    let params = new HttpParams();
    if (pagination) {
      params = params.append('pageSize', pagination.pageSize);
      params = params.append('page', pagination.currentPage);
    ...
    return this.httpClient.get<{ data: ProductBrand[], message?: string, count: number }>(API_BRAND + 'get-all-brands-with-count', { params });
  }

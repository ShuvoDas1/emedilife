...
import { addProductBySearchByAdminCustomOrder } from './../../utils/url';
...
export class ProductService {
  ...
  getSearchProduct(searchTerm: string, pagination?: Pagination, filter?: any) {
    ...
    // return this.http.post<{ data: Product[], count: number }>(API_PRODUCT + 'get-products-by-search-for-custom-order', filter, { params });
  }


  addProductBySearchByAdminCustomOrder(searchTerm: string, pagination?: Pagination, filter?: any) {
    ...
    return this.http.get<{ data: Product[], count: number }>(addProductBySearchByAdminCustomOrder, { params });
  }

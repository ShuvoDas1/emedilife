...
import { QuickViewDialogComponent } from '../product-card-one/quick-view-dialog/quick-view-dialog.component';
import { WishlistSchema } from 'src/app/interfaces/wishlist';
import { ProductService } from 'src/app/services/product.service';



@Component({
  selector: 'alternative-product-card',
  templateUrl: './alternative-product-card.component.html',
  styleUrls: ['./alternative-product-card.component.scss']
})
export class AlternativeProductCardComponent implements OnInit {

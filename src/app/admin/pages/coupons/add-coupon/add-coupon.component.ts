  ...
  onSubmit() {
    ...
    const mData = {
      ...
      ...{
        ...
        couponStartTimeString: this.utilsService.timeConvertTo12Hours(this.dataForm.value.couponStartTime),
        couponEndTimeString: this.utilsService.timeConvertTo12Hours(this.dataForm.value.couponEndTime)
      }
    };

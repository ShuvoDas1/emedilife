...
const routes: Routes = [
  {
    ...
    children: [
      ...
      {
        path: 'category-menu',
        loadChildren: () => import('./customization/category-menu/category-menu.module').then(m => m.CategoryMenuModule),
        canActivate: [CheckAuthAccessGuard]
      },
      {
        path: 'carousel',
        loadChildren: () => import('./customization/carousels/carousels.module').then(m => m.CarouselsModule),
        canActivate: [CheckAuthAccessGuard]
      },
      {
        path: 'shop-info',
        loadChildren: () => import('./customization/shop-info/shop-info.module').then(m => m.ShopInfoModule),
        canActivate: [CheckAuthAccessGuard]
      },
      {
        path: 'attributes',
        loadChildren: () => import('./catalog/attributes/attributes.module').then(m => m.AttributesModule),
        canActivate: [CheckAuthAccessGuard]
      },
      {
        path: 'generics',
        loadChildren: () => import('./catalog/generics/generics.module').then(m => m.GenericsModule),
        canActivate: [CheckAuthAccessGuard]
      },
      {
        path: 'unit-types',
        loadChildren: () => import('./catalog/unit-types/unit-types.module').then(m => m.UnitTypesModule),
        canActivate: [CheckAuthAccessGuard]
      },
      {
        path: 'brands',
      ...
      {
        path: 'sub-categories',
        loadChildren: () => import('./catalog/sub-categories/sub-categories.module').then(m => m.SubCategoriesModule),
        canActivate: [CheckAuthAccessGuard]
      },
      {
        path: 'products',
      ...
      },
      {
        ...
        canActivate: [CheckAuthAccessGuard, EditorAuthRoleGuard],
        loadChildren: () => import('./prescription-order/prescription-order.module').then(m => m.PrescriptionOrderModule)
      },
      {
        path: 'transactions',
        canActivate: [CheckAuthAccessGuard, EditorAuthRoleGuard],
      ...
      {
        path: 'footer-data',
        loadChildren: () => import('./customization/footer-data/footer-data.module').then(m => m.FooterDataModule),
        canActivate: [CheckAuthAccessGuard]
      },
      {
        path: 'career-esquire',
      ...
      {
        path: 'promo-page',
        loadChildren: () => import('./customization/promo-page/promo-page.module').then(m => m.PromoPageModule)
      },
      {
        path: 'discussions',

...
export class AdditionalPagesComponent implements OnInit {
  ...
  allPages: object[] = [
    ...
    {_id: 1, name: 'Press Coverage', slug: 'press-coverage'},
    {_id: 1, name: 'IP Policy', slug: 'ip-policy'},
    {_id: 1, name: 'Career', slug: 'career-at-emedilife'},
    ...
    {_id: 7, name: 'Grievance Redressal', slug: 'grievance-redressal'},

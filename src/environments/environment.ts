...
export const environment = {
  production: false,
  // apiBaseLink: 'http://localhost:9999',
  // apiBaseLink: 'https://api.emedilife.com',
  apiBaseLink: 'https://api.emedilife.com',
  // ftpBaseLink: 'http://localhost:3000',
  ftpBaseLink: 'https://ftp.emedilife.com',
  appBaseUrl: '/',
  userBaseUrl: '/account',
  userLoginUrl: '/login',
  ...
  sslIpnUrl: 'https://api.emedilife.com/api/payment-ssl/ipn',
  smsUser: 'UIO',
  smsPass: 'ABC',
  smsSid: 'XYZ',
  firebaseConfig: {
